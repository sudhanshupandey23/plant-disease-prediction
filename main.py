...
if app_mode == "Home":
    ...
    2. **Analysis:** Our system will process the image using advanced Deep learning algorithms.
    3. **Results:** View the results and recommendations for further action.

    ### 🌟 Why Choose Us?
    - **Accuracy:** State-of-the-art Deep learning models for precise disease detection.
...
# About Project
    ...
    <div style="text-align: justify;">
        This project aims to help farmers and gardeners identify plant diseases early and accurately. By leveraging Deep learning, we provide a tool that can analyze images of plant leaves and detect diseases with high precision.
    </div>
    """, unsafe_allow_html=True)
